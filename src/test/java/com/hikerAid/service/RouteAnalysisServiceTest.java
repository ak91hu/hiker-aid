...
class RouteAnalysisServiceTest {
    ...
    void fitnessPaceAffectsTime() {
        ...
        AnalysisResult beginner = service.analyzeWithWeight(data, 70, 170, 0,1, 8, 0);
        AnalysisResult average = service.analyzeWithWeight(data, 70, 170, 0,3, 8, 0);
        AnalysisResult veryFit = service.analyzeWithWeight(data, 70, 170, 0,5, 8, 0);
    ...
    void safetyAnalysisPresent() {
        ...
        AnalysisResult result = service.analyzeWithWeight(data, 70, 170, 0,3, 8, 0);
